deepspeed llava/train/train_mem.py \
    ...
    --vision_tower ./ckpts/siglip-large-patch16-256 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-siglip-vit-l-256-qwen-v1.5-1.8b-pretrain \
    --num_train_epochs 1 \
...
deepspeed llava/train/train_mem.py \
    ...
    --image_folder data \
    --vision_tower ./ckpts/siglip-large-patch16-256 \
    --pretrain_mm_mlp_adapter ./checkpoints/llava-siglip-vit-l-256-qwen-v1.5-1.8b-pretrain/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-siglip-vit-l-256-qwen-v1.5-1.8b \
    --num_train_epochs 1 \
